...
use ddaBundle\FrontBundle\Entity\Actualite;
...
class ActualiteController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ddaBundle\FrontBundle\Form\ActualiteType', $actualite);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_dda_actualite_show', array('id' => $actualite->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($actualite);
        $editForm = $this->createForm('ddaBundle\FrontBundle\Form\ActualiteType', $actualite);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('admin_dda_actualite_edit', array('id' => $actualite->getId()));
        }
    ...
    public function deleteAction(Request $request, Actualite $actualite)
    {
        ...
        return $this->redirectToRoute('admin_dda_actualite_index');
    }
